  ...
  useEffect(() => {
    ...
    const finalizeOrder = async () => {
      try {
        ...
        const { data: session } = await apiClient.get(`/stripe/session/${sessionId}`);
      ...
      <div className="order-processing-container">
        <div className="order-error-card">
          ...
          <p className="error-message">
            Ihre Zahlung wurde noch nicht bestätigt. Bitte überprüfen Sie Ihre E-Mails oder
    ...
    return (
      <div className="order-processing-container">
        <div className="order-error-card">
          ...
          <p className="error-message">
            Es ist ein Fehler beim Speichern Ihrer Bestellung aufgetreten. Bitte kontaktieren Sie
            unseren Support.
          </p>
          <Link to="/produkte" className="success-button-primary">
            Zurück zum Shop
    ...
    <div className="order-success-container">
      <div className="order-success-card">
        ...
        <p className="success-message">
          Wir haben Ihre Bestellung erhalten und werden sie so schnell wie möglich bearbeiten. Eine
        ...
        <div className="success-info-box">
          ...
          <p className="info-box-text">
            Sie erhalten eine Versandbestätigung mit Tracking-Informationen, sobald Ihre Bestellung
            versandt wurde.
          </p>
        </div>
